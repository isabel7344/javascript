...
let createPerson = function () {
  ...
  person['age']=45
  person['city']='Paris'
  //  Ici est considéré comme un objet et pas comme un tableau let person = {"name": 'jean' ,"age": '45' ,"city": 'Paris'};
  return person;
}
...
let returnSentence = function (array) {
  return "Bonjour, je suis " + array['name'] + ". J\'ai "+ array['age'] +" ans et j\'habite "+ array['city'] +".";
}
